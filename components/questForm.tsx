...
const QuestForm: React.FC<QuestFormProps> = ({ onBack }) => {
  ...
  const [category, setCategory] = useState<string>("values");
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.inputGroup}>
        ...
        <Text style={styles.hint}>
          Common categories: {predefinedCategories.join(", ")}
        </Text>
      </View>
      ...
      <View style={styles.inputGroup}>
        ...
        />
        <Text style={styles.hint}>
          Points awarded for completing this quest
        </Text>
      </View>
